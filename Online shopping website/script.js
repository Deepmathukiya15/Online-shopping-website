...
function addToCart(event){
    ...
    <td class="uk-table-link">
        <h5 class = "item-name"><b>${itemName}</b></h5>
    </td>
    <td class="uk-text-truncate item-price"><h5><b>${itemPrice}</b></h5></td>
    <td><input type = 'number' class = 'num' value = '1'></td>
    <td class="uk-text-truncate total-price"><h5><b>${itemPrice}</b></h5></td>
